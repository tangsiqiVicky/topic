<template>
  <section>
    <header class="top_tips">
      ...
      <span class="num_tip" v-if="fatherComponent === 'item'">题目</span>
    </header>
    <div v-if="fatherComponent === 'home'">
      <div class="home_logo item_container_style"></div>
      <router-link to="about" class="start button_style"></router-link> 
    </div>
...
export default {
  ...
  created () {
    if(this.fatherComponent == 'home') {
      this.initializeData()
      document.body.style.backgroundImage = 'url(./img/1-1.a92218b4.jpg)'
    }
  }
}
</script>
